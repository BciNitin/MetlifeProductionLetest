<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StoreMaster.aspx.cs" Inherits="WebPages_StoreMaster" MasterPageFile="~/WebPages/MobiVUEMaster.master" Title="BCIL : ATS - Store Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        function ClearFields() {
            document.getElementById('<%= txtStoreName.ClientID%>').value = "";
                            ...
                            <table id="Table2" runat="server" style="width: 100%;" cellspacing="10" align="center">
                                ...
                                <tr>
                                    <td style="text-align: right">
                                        ...
                                        <asp:Label ID="Label9" runat="server" Text="Store Name" CssClass="label"></asp:Label>
                                    </td>
                                    <td style="text-align: center">
                                        <div style="font-weight: bold">
                                            :
                                    ...
                                    <td style="text-align: left">
                                        <asp:TextBox ID="txtStoreName" runat="server" autocomplete="off" CssClass="textbox" MaxLength="50" TabIndex="2" ToolTip="Enter Store Name" Width="200px"></asp:TextBox>
                                        <%--<asp:RegularExpressionValidator ID="revStoreName" runat="server" Display="dynamic"
                                            ControlToValidate="txtStoreName" ValidationGroup="Submit" CssClass="validation"
                                            ValidationExpression="^[a-zA-Z ]+$" ErrorMessage="[Alphabet]">
                                        </asp:RegularExpressionValidator>--%>
                                        <asp:RequiredFieldValidator ID="rfvStoreName" runat="server" ControlToValidate="txtStoreName" ValidationGroup="Submit" CssClass="validation"
                                            ErrorMessage="[Required]">
                                        </asp:RequiredFieldValidator>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="6" align="center">
                                        <asp:Button ID="btnSubmit" runat="server" ValidationGroup="Submit" TabIndex="12" 
                                            ToolTip="Save Store Details" Text="Save" CssClass="button" AutoPostBack="true"
                ...
                <td colspan="4" align="center">
                    <div id="DivGrid">
                        <asp:UpdatePanel ID="upGrid" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="gvStoreMaster" runat="server" AllowPaging="True" OnRowDeleting="gvStoreMaster_RowDeleting"
                                    OnRowEditing="gvStoreMaster_RowEditing" OnRowUpdating="gvStoreMaster_RowUpdating"
                                    OnRowCancelingEdit="gvStoreMaster_RowCancelingEdit" AutoGenerateColumns="False"
                                    OnRowDataBound="gvStoreMaster_RowDataBound" ShowFooter="false" CssClass="mGrid"
                                    PageSize="50" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt" OnPageIndexChanging="gvStoreMaster_PageIndexChanging">
                                    <Columns>
                                        <asp:TemplateField HeaderText="Store Code" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblStoreCode" runat="server" Text='<%#Eval("STORE_CODE") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:Label ID="lblEStoreCode" runat="server" Text='<%#Eval("STORE_CODE") %>'></asp:Label>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Store Name">
                                           ...
                                           <%-- <EditItemTemplate>
                                                <asp:TextBox autocomplete="off" ID="txtEStoreName" CssClass="textbox" Width="100px"
                                                    ValidationGroup="Grid" MaxLength="50" runat="server" Text='<%#Eval("STORE_NAME") %>'></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="rfvEEmpName" runat="server" ControlToValidate="txtEStoreName"
                            ...
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="gvStoreMaster" EventName="RowDeleting" />
                                <asp:AsyncPostBackTrigger ControlID="gvStoreMaster" EventName="RowUpdating" />
                                <asp:AsyncPostBackTrigger ControlID="gvStoreMaster" EventName="RowEditing" />
                                <asp:AsyncPostBackTrigger ControlID="gvStoreMaster" EventName="RowCancelingEdit" />
                                <asp:AsyncPostBackTrigger ControlID="gvStoreMaster" EventName="PageIndexChanging" />
                            </Triggers>
                        </asp:UpdatePanel>
                    </div>
                </td>
