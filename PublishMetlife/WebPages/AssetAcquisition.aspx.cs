...
public partial class WebPages_AssetAcquisition : System.Web.UI.Page
{
    ...
    public WebPages_AssetAcquisition()
    {
        oPRP = new AssetAcquisition_PRP();
    }
    ~WebPages_AssetAcquisition()
    {
        oPRP = null;
        oDAL = null;
    }
    ...
    private void SaveAssetDetails()
    {
        try
        {
            ...
            if (dtFileData.Columns.Count != 21)
            {
            ...
            for (iCnt = 0; iCnt < dtFileData.Rows.Count; iCnt++)
            {
                ...
                if (dtFileData.Rows[iCnt][2].ToString().Trim() != "")
                    oPRP.AssetType = dtFileData.Rows[iCnt][2].ToString().Replace("'", "`").Trim();
                else
                {
                ...
                if (dtFileData.Rows[iCnt][3].ToString().Trim() != "")
                {
                    ...
                    oPRP.AssetMakeName = dtFileData.Rows[iCnt][3].ToString().Replace("'", "`").Trim();
                ...
                oPRP.AssetModelName = dtFileData.Rows[iCnt][4].ToString().ToUpper().Replace("'", "`").Trim();
                ...
                oPRP.AssetCode = dtFileData.Rows[iCnt][5].ToString().ToUpper().Replace("'", "`").Trim();
                if (oPRP.AssetCode == "")
                {
                ...
                oPRP.AssetID = dtFileData.Rows[iCnt][6].ToString().ToUpper().Replace("'", "`").Trim();
                oPRP.AssetTag = dtFileData.Rows[iCnt][7].ToString().ToUpper().Replace("'", "`").Trim();
                oPRP.Status = dtFileData.Rows[iCnt][8].ToString().ToUpper().Replace("'", "`").Trim();
                if (oPRP.Status == "")
                {
                ...
                oPRP.SubStatus = dtFileData.Rows[iCnt][9].ToString().ToUpper().Replace("'", "`").Trim();
                if (oPRP.SubStatus == "")
                {
                ...
                oPRP.store = dtFileData.Rows[iCnt][10].ToString().ToUpper().Replace("'", "`").Trim();
                oPRP.AssetProcessor = dtFileData.Rows[iCnt][11].ToString().ToUpper().Replace("'", "`").Trim();
                ...
                oPRP.AssetRAM = dtFileData.Rows[iCnt][12].ToString().ToUpper().Replace("'", "`").Trim();
                if (oPRP.AssetRAM == "")
                {
                ...
                oPRP.AssetHDD = dtFileData.Rows[iCnt][13].ToString().Trim().ToUpper();
                if (oPRP.AssetHDD == "")
                {
                ...
                oPRP.AMC_Warranty = dtFileData.Rows[iCnt][14].ToString().ToUpper().Replace("'", "`").Trim();
                ...
                oPRP.GRNNo = dtFileData.Rows[iCnt][15].ToString().ToUpper().Replace("'", "`").Trim();
                if (oPRP.GRNNo == "")
                {
                ...
                oPRP.VendorCode = dtFileData.Rows[iCnt][16].ToString().Replace("'", "`").Trim();
                if (oPRP.VendorCode == "")
                {
                ...
                oPRP.PurchaseOrderNo = dtFileData.Rows[iCnt][17].ToString().Trim().ToUpper();
                ...
                oPRP.PODate = Convert.ToDateTime(dtFileData.Rows[iCnt][18].ToString().Trim()).ToString("dd-MMM-yyyy");
                if (oPRP.PODate == "")
                {
                ...
                oPRP.InvoiceNo = dtFileData.Rows[iCnt][19].ToString().Trim().ToUpper();
                if (oPRP.InvoiceNo == "")
                {
                ...
                oPRP.InvoiceDate = Convert.ToDateTime(dtFileData.Rows[iCnt][20].ToString().Trim()).ToString("dd-MMM-yyyy");
                if (oPRP.InvoiceDate == "")
                {
                ...
                oPRP.Remarks = dtFileData.Rows[iCnt][21].ToString().Trim().ToUpper();
                oPRP.AssetQty = "1";
                //if (oPRP.AssetQty == "")
                //{
