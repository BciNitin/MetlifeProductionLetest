<%@ Page Title="" Language="C#" MasterPageFile="~/WebPages/MobiVUEMaster.master" AutoEventWireup="true" CodeFile="AssetAcquisition.aspx.cs" Inherits="WebPages_AssetAcquisition" %>
                                            ...
                                            <table id="Table3" runat="server" style="width: 100%;" cellspacing="10" align="center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: left; width: 24%">
                                                     ...
                                                     <td style="text-align: right; width: 24%">
                                                          <a href="DownloadSample/IT_ASSETS_ACQUISTATION.xlsx" class="textbox">Download IT Assets Format</a>
                                                      </td>
                                                     <td style="text-align: right; width: 24%">
