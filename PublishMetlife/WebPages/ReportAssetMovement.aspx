<%@ Page Title="" Language="C#" MasterPageFile="~/WebPages/MobiVUEMaster.master" AutoEventWireup="true" CodeFile="ReportAssetMovement.aspx.cs" Inherits="UploadedFiles_WebPages_ReportAssetMovement" %>
                        ...
                        <asp:GridView ID="gvRptGatePass" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Asset Tag">
                                    <ItemTemplate>
                                        <asp:Label ID="lblCompCode" runat="server" Text='<%#Eval("ASSET_ID") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="RFID Tag">
                                    <ItemTemplate>
                                        <asp:Label ID="lblGPDate" runat="server" Text='<%#Eval("AssetTag") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="EMP ID">
                                    <ItemTemplate>
                                        <asp:Label ID="lblGPType" runat="server" Text='<%#Eval("EMPLOYEE_CODE") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="EMP NAME">
                                    <ItemTemplate>
                                        <asp:Label ID="lblExpRtnDate" runat="server" Text='<%#Eval("EMPLOYEE_NAME") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="EMP TAG">
                                    <ItemTemplate>
                                        <asp:Label ID="lblAssetCode" runat="server" Text='<%#Eval("EmployeeTag") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Scanned Time">
                                    <ItemTemplate>
                                        <asp:Label ID="lblGPIndate" runat="server" Text='<%#Eval("ScannedDateTime") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Movement Staus">
                                    <ItemTemplate>
                                        <asp:Label ID="lblGPOutLoc" runat="server" Text='<%#Eval("Movement Type") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
