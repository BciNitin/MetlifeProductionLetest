...
public partial class WebPages_ReportProfitAndLoss : System.Web.UI.Page
{
    RptProfitAndLoss_DAL oDAL = default(RptProfitAndLoss_DAL);
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            oDAL = new RptProfitAndLoss_DAL(DataBaseName);
            if (!IsPostBack)
            {
    ...
    protected void btnSubmit_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            DataTable tbl = oDAL.GetProfitAndLossData(CompCode, ToDate);
            this.gvDProfitAndLoss.DataSource = Session["ProfitAndLoss"] = tbl;
            this.gvDProfitAndLoss.DataBind();
    ...
    protected void btnExport_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            if (gvDProfitAndLoss.Rows.Count > 0)
            {
                Response.Clear();
                DataTable dt = (DataTable)Session["ProfitAndLoss"];
                ...
                //Response.AddHeader("Content-Disposition", "attachment;filename=ProfitAndLoss.xls");
    ...
    protected void gvDProfitAndLoss_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        try
        {
            gvDProfitAndLoss.PageIndex = e.NewPageIndex;
