<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AssetAcq.aspx.cs" MasterPageFile="~/WebPages/MobiVUEMaster.master" Inherits="WebPages_AssetAcq" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ShowAlertCommon(ShowMsg) {
                            ...
                            <table id="Table2" runat="server" style="width: 100%;" cellspacing="10" align="center">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left; vertical-align: top">
                                        ...
                                        <asp:RequiredFieldValidator ID="RFVtxtSubCategory" runat="server" ControlToValidate="txtSubCategory" CssClass="validation" ValidationGroup="Submit" Display="Dynamic" ErrorMessage="[Required]">
                                ...
                                <tr>
                                    <td style="text-align: right">
                                        <asp:Label ID="Label37" runat="server" Text="Procurement Budget" CssClass="label"></asp:Label>
                                    </td>
                                    <td style="text-align: center">
                                        <div style="font-weight: bold">
                                            :
                                    ...
                                    <td style="text-align: left">
                                        ...
                                        <asp:DropDownList ID="ddlProcurementBudget" runat="server" CssClass="dropdownlist" TabIndex="15" ToolTip="Enter Procurement Budget" Width="200px">
                                            <asp:ListItem Value="">-- Select Procurement Budget --</asp:ListItem>
                                            <asp:ListItem Value="Capex">Capex</asp:ListItem>
                                            <asp:ListItem Value="R&M">R&M</asp:ListItem>
                                            <asp:ListItem Value="Reinvestment">Reinvestment</asp:ListItem>
                                ...
                                <tr class="all-asset-display-none Facilities-display">
                                    ...
                                    <td style="text-align: right">
                                        ...
                                        <asp:Label ID="Label16" runat="server" Text="Asset Working Status" CssClass="label"></asp:Label>
                                    </td>
                                    <td style="text-align: center">
                                        <div style="font-weight: bold">
                                            :
                                ...
                                <tr class="all-asset-display-none IT-display">
                                    ...
                                    <td style="text-align: left">
                                        <asp:TextBox ID="txtAssetTag" runat="server" autocomplete="off" CssClass="textbox" MaxLength="50" TabIndex="8" ToolTip="Enter Asset Tag" Width="200px"></asp:TextBox>
                                ...
                                <tr class="all-asset-display-none Facilities-display">
                                    ...
                                    <td style="text-align: right">
                                        ...
                                        <asp:Label ID="Label33" runat="server" Text="Asset End Life" CssClass="label"></asp:Label>
                                    </td>
                                    <td style="text-align: center">
                                        <div style="font-weight: bold">
                                            :
                                    ...
                                    <td style="text-align: left">
                                        <asp:TextBox ID="txtAssetEndLife" runat="server" autocomplete="off" CssClass="textbox" MaxLength="50" TabIndex="24" ToolTip="Enter In service Date" Width="200px"></asp:TextBox>
                                        <%--<asp:RequiredFieldValidator ID="RFVtxtEndLifeCycle" runat="server" ControlToValidate="txtAssetEndLife" CssClass="validation" ValidationGroup="Submit" Display="Dynamic" ErrorMessage="[Required]"></asp:RequiredFieldValidator>--%>
                                        <asp:RequiredFieldValidator ID="RFVtxtEndLifeCycle" runat="server" ControlToValidate="txtAssetEndLife" CssClass="validation" InitialValue="" ValidationGroup="Submit" Display="Dynamic" ErrorMessage="[Required]"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="DownloadSample/ASSETS_ACQUISITITION_FACILITIES.xlsx" class="all-asset-display-none Facilities-display">
                                                <input type="button" class="button btn btn-secondary" value="Download Template" style="padding: 5px" />
                                            </a>
                                        </td>
                                    </td>
